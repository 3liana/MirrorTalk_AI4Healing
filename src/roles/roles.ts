...
export const ROLES: RoleProfile[] = [
  {
    ...
    safetyFrame: "我们不是在做诊断或治疗。我只是一个经历过困惑的同行者，和你聊聊你的想法。",    keyMoments: [
    ...
    ],  },
  {
    ...
    safetyFrame: "这里没有对错，只有你自己真实的感受。我们一起探索一下。",    keyMoments: [
    ...
    ],  },
  {
    ...
    safetyFrame: "我的角色不是给你答案，而是帮你看见你自己的答案。",    keyMoments: [
    ...
    ],  },
  {
    ...
    safetyFrame: "你的感受很重要，无论它们看起来多么混乱或矛盾。",    keyMoments: [
  ...
  },
  {
    ...
    safetyFrame: "我们在这里没有竞争，只有一个安全的空间让你探索自己。",    keyMoments: [
